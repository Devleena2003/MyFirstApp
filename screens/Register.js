...
export default function Register({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      <Text style={{ color: "#D4ADFC", fontSize: 40, marginBottom: 60 }}>
        Welcome!
      </Text>
      ...
      <View style={styles.inputView}>
        <Text style={{ position: "absolute", left: 35, top: 20 }}>
          {" "}
          <MaterialCommunityIcons name={"email"} size={20} color={"#0C134F"} />
        </Text>
        <TextInput
          style={styles.TextInput}
          placeholder="Email"
      ...
      <View style={styles.inputView}>
        <Text style={{ position: "absolute", left: 35, top: 20 }}>
          {" "}
          <MaterialCommunityIcons name={"lock"} size={20} color={"#0C134F"} />
        </Text>
        <TextInput
          style={styles.TextInput}
